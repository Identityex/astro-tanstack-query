...
- A prefetch that failed renders as pending and loading, not as an error. Errored queries are not sent to the browser, so the browser starts from nothing and fetches.
